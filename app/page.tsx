    ...
    <main className="h-screen overflow-hidden bg-[#f1f3f5] text-gray-800 flex flex-col font-sans relative">
        ...
        <div className="max-w-[1600px] mx-auto px-4 sm:px-6 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <img
              src="/logo.png"
              alt="Logo"
              className="w-9 h-9 object-cover rounded-xl shadow-sm border border-gray-100"
            />
      ...
      <div className="flex-1 max-w-[1600px] w-full mx-auto p-3 sm:p-5 overflow-hidden">
        <div className="flex flex-col md:flex-row gap-4 lg:gap-6 h-full">
          {/* 1. 左侧：输入区 (Markdown) */}
          <div
            className={`flex-[1.2] flex-col bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden ${activeTab === "input" ? "flex" : "hidden md:flex"}`}
          >
