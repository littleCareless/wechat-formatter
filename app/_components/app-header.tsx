...
export function AppHeader({
  ...
  return (
    <header className="bg-[var(--neo-app-header)] border-b-[3px] border-[var(--neo-ink)] sticky top-0 z-20">
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 py-3 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          />
          <h1 className="text-lg sm:text-2xl font-black tracking-tight uppercase text-[var(--neo-on-header)]">
            公众号排版助手
          </h1>
        </div>
      ...
      <div className="flex gap-2 bg-[var(--neo-sub-header)] border-t-[3px] border-[var(--neo-ink)] p-2 md:hidden">
        <button
