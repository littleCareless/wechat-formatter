...
async function uploadImageToWeChat(accessToken, imageBuffer, filename) {
...
async function processHtmlImages(accessToken, html) {
...
// ─── 封面上传 ──────────────────────────────────────────────────────────
async function uploadCoverToWeChat(accessToken, imageBuffer, filename) {
...
// ─── 草稿创建 ──────────────────────────────────────────────────────────
async function addWeChatDraft(accessToken, title, content, thumbMediaId, author, digest) {
...
// ─── 主流程 ────────────────────────────────────────────────────────────
export async function createWeChatDraft(appId, appSecret, article) {
    ...
    // 5. 创建草稿
    try {
        const mediaId = await addWeChatDraft(accessToken, article.title, finalHtml, thumbMediaId, article.author || "", digest);
